...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      //convert skills array to comma separated value
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info=" A unique handle for your profile URL. Your full name, company name, nickname, etc. (This can be changed later)"
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                  ...
                  error={errors.status}
                  options={options}
                  info="Give us an idea of where you are in your professional career"
                />
                <TextFieldGroup
                  placeholder="Company"
                  name="company"
